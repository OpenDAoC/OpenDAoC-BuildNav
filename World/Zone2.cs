...
namespace CEM.World
{
    ...
    internal class Zone2
    {
        ...
        private Zone2(Region region, ushort id, string name, int xoffset, int yoffset, int width, int height, eZoneType type, ushort proxyZone)
        {
            Region = region;
            ID = id;
            Name = name.Trim();
        ...
        /// </summary>
        public bool Contains(Datastructures.IPoint3D vec)
        {
